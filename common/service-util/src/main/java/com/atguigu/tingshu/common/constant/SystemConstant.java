...
public class SystemConstant {
    ...
    public static final String ALBUM_STATUS_ARTIFICIAL = "0303";  // 需要人工审核
    ...
    public static final String TRACK_STATUS_ARTIFICIAL = "0503";  // 需要人工审核
    public static final String TRACK_STATUS_REVIEWING = "0504";  // 审核中
